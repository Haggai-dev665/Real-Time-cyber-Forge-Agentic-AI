...
out += rect(600, 180, 260, 60, ["Tauri Desktop App", "Intersects URL Activity"]) + "\\n";
...
out += rect(300, 690, 200, 60, ["URL Phishing BERT", "FastAPI / HuggingFace"], "ai-box") + "\\n";
out += rect(600, 690, 200, 60, ["DGA Detector", "Entropy Heuristics"]) + "\\n";
out += rect(900, 690, 200, 60, ["Web Scraper", "Headless Chrome DOM Fetch"]) + "\\n";
...
out += rect(300, 1400, 240, 70, ["Trigger UI Alert!", "Notify user instantly / Protect"], "alert-box") + "\\n";
